...
for iKey in dictInfo.keys():
    ...
    inputFileName = "data_site_highResolution/"+iKey+"_"+str(begYear)+"-"+str(endYear)+".csv"
    ...
    for i in range(0,m-1):
        ...
        print(lon1,lat1,lonSite,latSite)
    ...
    # output
    outFileName = "data_allTyKeyParameter_highResolution/"+iKey+"KeyParameters.csv"
